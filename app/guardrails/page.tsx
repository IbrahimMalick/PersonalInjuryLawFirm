...
import { CONDUCT_RULES, REPLY_DISCLAIMER, REVIEW_RULES } from "@/lib/guardrails";
        ...
        <div className="space-y-4">
          <section>
            ...
            <div className="rounded-sm bg-paper text-papertext p-4 text-[14px] leading-snug space-y-3">
              <p>{REPLY_DISCLAIMER.en}</p>
              <p className="border-t border-papertext/15 pt-3">{REPLY_DISCLAIMER.es}</p>
            </div>
          </section>
